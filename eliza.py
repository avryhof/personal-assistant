...
psychobabble = [
    ...
    [r'quit|bye|goodbye|good\sbye|so\slong|farewell',
...
def speech_recognize(audio_source):
    ...
    if RECOGNITION_ENGINE == 'google':
        return r.recognize_google(audio_source, key=GOOGLE_SPEECH_RECOGNITION_API_KEY)
    ...
    if RECOGNITION_ENGINE == 'ibm':
        return r.recognize_ibm(audio_source, username=IBM_USERNAME, password=IBM_PASSWORD)
